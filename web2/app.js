...
async function getVozila() {
    ...
    try {
        ...
        let row
        const response = await fetch(`${BASE_URL}vozila`)
...
async function deleteVozilo(voziloId) {
    try {
        ...
        const response = await fetch(`${BASE_URL}vozila/${voziloId}`, {
            method: "DELETE"
        })
...
const openUpdateModal = async (idVozila) => {
    ...
    try {
        ...
        const response = await fetch(`${BASE_URL}vozila/${idVozila}`)
...
const updateVozilo = async () => {
    ...
    try {
        ...
        const response = await fetch(`${BASE_URL}vozila/${idSelektovanogVozila}`, {
